...
#     domain_path = os.path.join(root_path, domain_name)
    ...
    # add more parameters if Gamma parameters are included in object_params.
    Gamma_params = ['routingGammaScale', 'routingGammaShape']
    if any(Gamma_param in object_params for Gamma_param in Gamma_params):
        for Gamma_param in Gamma_params:
            if not Gamma_param in object_params:
                output_params.append(Gamma_param)   
