...
root_path              | /home/h294liu/project/proj/5_summaCalib/BowAtBanff  # root path where parameter estimation will be stored.
domain_name            | xxxxxx   # use as the domain folder name for the prepared data.

## ---- PART 2. Hydrologic model settings  ---- 
model_src_path         | /home/h294liu/project/proj/5_summaCalib/BowAtBanff_default/model # path of source hydrologic model.
...
simEndTime             | 2013-10-01 00:00      # simualtion end time for parameter estimation, in format yyyy-mm-dd hh:mm.  
...
ostIn_tpl              | ostIn.SCE.tpl                 # Name of ostIn template file. Workflow input in '[calib_path]/tpl/[ostIn_tpl]'. eg, ostIn.GLUE.tpl/ostIn.SCE.tpl/ostIn.GA.tpl/ostIn.DDS.tpl
