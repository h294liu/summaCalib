...
domain_name            | BowAtBanff3   # use as the domain folder name for the prepared data.
...
simEndTime             | 2011-09-30 23:00      # simualtion end time for parameter estimation, in format yyyy-mm-dd hh:mm.  
...
statStartDate          | 2009-10-01                   # Start date of statistics calculation period, in format yyyy-mm-dd. 
statEndDate            | 2011-09-30                   # End date of statistics calculation period, in format yyyy-mm-dd.  
