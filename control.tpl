...
domain_name            | BowAtBanff_default   # use as the domain folder name for the prepared data.
...
simStartTime           | 2008-10-01 00:00      # simualtion start time for parameter estimation, in format yyyy-mm-dd hh:mm. 
simEndTime             | 2010-10-01 00:00      # simualtion end time for parameter estimation, in format yyyy-mm-dd hh:mm.  
...
max_iterations         | 1                         # Maximum Number of iterations for optimization. Optional, depending on the optimization method.
...
statStartDate          | 2008-10-01                   # Start date of statistics calculation period, in format yyyy-mm-dd. 
statEndDate            | 2010-10-01                   # End date of statistics calculation period, in format yyyy-mm-dd.  
